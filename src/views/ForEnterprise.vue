...
<template>
  ...
  <!-- 3. How it works — we provide everything -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <div class="reveal-left stagger-1 hud-panel hud-corners p-6">
          ...
          <ul class="space-y-2.5">
            <li
              v-for="(item, i) in tm('enterprise.we_provide')"
              :key="i"
        ...
        <div class="reveal-right stagger-2 hud-panel hud-corners p-6">
          ...
          <ul class="space-y-2.5">
            <li
              v-for="(item, i) in tm('enterprise.you_get')"
              :key="i"
              class="flex gap-3 text-xs"
            >
  ...
  <!-- 4. Key Advantages — failover, hotspare, remote office -->
  <section class="py-20 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <ul class="space-y-2">
            <li
              v-for="(point, pi) in tm(`enterprise.adv_${a.key}_points`)"
              :key="pi"
